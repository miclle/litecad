...
- Continue the AI Parametric Assistant described in [docs/ai-parametric-assistant.md](docs/ai-parametric-assistant.md) and [docs/superpowers/plans/2026-07-11-ai-parametric-assistant.md](docs/superpowers/plans/2026-07-11-ai-parametric-assistant.md): browser compile/preview for generated OpenSCAD-style artifacts, saved generated model sources, durable parameter revision editing, and later LiteCAD-native OCCT feature DSL support. Multi-session Assistant conversations, strict `build_parametric_model` JSON validation, pending artifact draft creation, and an Inspector-side draft editor with parsed parameter controls are implemented, but generated artifacts are not project models until the compatible browser compile runtime and explicit save flow ship.
