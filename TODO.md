...
- Continue the AI Parametric Assistant described in [docs/ai-parametric-assistant.md](docs/ai-parametric-assistant.md) and [docs/superpowers/plans/2026-07-11-ai-parametric-assistant.md](docs/superpowers/plans/2026-07-11-ai-parametric-assistant.md): browser compile/preview for generated OpenSCAD-style artifacts, parameter editing, saved generated model sources, and later LiteCAD-native OCCT feature DSL support. Multi-session Assistant conversations, strict `build_parametric_model` JSON validation, and pending artifact draft creation are implemented, but generated artifacts are not project models until the browser compile and explicit save flow ship.
