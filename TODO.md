...
- Continue assembly semantics beyond the completed CAD document schema v2 flat assembly, where multiple occurrences may reference one immutable model revision and independently own name, order, suppression, placement, deletion, History, and separate or compound STEP export semantics.
