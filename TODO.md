...
- Continue the AI Parametric Assistant described in [docs/ai-parametric-assistant.md](docs/ai-parametric-assistant.md) and [docs/superpowers/plans/2026-07-11-ai-parametric-assistant.md](docs/superpowers/plans/2026-07-11-ai-parametric-assistant.md): browser compile/preview for generated OpenSCAD-style artifacts, durable parameter revision editing, and later LiteCAD-native OCCT feature DSL support. Multi-session Assistant conversations, strict `build_parametric_model` JSON validation, pending artifact draft creation, an Inspector-side draft editor with parsed parameter controls, and save-as-`.scad` project model persistence for successful artifacts are implemented. The compatible browser compile runtime is still required before generated source can preview as mesh in normal use.
