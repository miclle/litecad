...
- Complete selected-model canvas interaction: select project models directly from the Three.js preview, highlight the selected model, and expose axis-based canvas translate controls that persist through the existing CAD document transform API.
