...
- Continue shrinking the project workbench hotspot by keeping demo-scene setup, model preview behavior, and page shell in focused modules with targeted tests.
