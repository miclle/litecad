...
- Continue assembly semantics beyond the completed CAD document schema v4 organizational tree and `point-coincident-v1` translation solver, where nested groups own hierarchical suppression, occurrences may reference one immutable model revision and independently own name, order, group, suppression, placement, deletion, History, and separate or compound STEP export semantics.
  ...
  - Add the project-local immutable reusable subassembly snapshot contract defined in the active implementation plan; keep live propagation, cross-project libraries, nested definitions, and nested STEP serialization out of scope until independently designed.
