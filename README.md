...
- Preview-layer workbench inspection tools for mesh edge overlays, center-plane visual sectioning, visible-model bounds measurement, and project-saved measurement/section inspection records.
...
- Preview inspection controls for edge display, center-plane sectioning, visible-model bounds measurement, and saved inspection records that survive reload.
