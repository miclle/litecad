...
- Database-backed operation History with owner-scoped Undo/Redo for occurrence creation/update/reorder/deletion, transforms, box unions, node deletion, and immutable model revision transitions, including persisted redo state across reloads and devices.
