...
- Workbench inspection tools for mesh edge overlays, center-plane visual sectioning, visible-model bounds plus derived diagonal measurement, project-saved measurement/section definitions, and project-owned OCCT section-edge STEP artifacts that can be restored, downloaded, and deleted after reload.
