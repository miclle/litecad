...
- Direct per-occurrence STEP downloads and selected multi-occurrence STEP compound downloads derived from unsuppressed occurrence order, revision bindings, names, and placements.
