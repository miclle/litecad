...
- Project data currently includes project metadata, uploaded STEP/STP/GLTF/GLB/STL source-file records, lightweight source metadata, preview artifact metadata, derived STEP/STL OBJ preview artifacts, backend-published GLTF/GLB preview artifacts, read-only model tree responses, and generated geometry version snapshots; it does not include editable CAD geometry.
