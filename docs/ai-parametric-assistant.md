...
3. The model calls `build_parametric_model` through native tools when supported; if native tool calling fails, LiteCAD retries with the strict fallback JSON shape.
