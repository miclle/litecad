...
- Treat general CAD merge/boolean operations and STEP export as roadmap work unless the code implements the end-to-end flow. A constrained per-model STEP box-union operation is implemented for the Phase 3 MVP.
