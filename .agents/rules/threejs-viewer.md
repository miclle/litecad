...
- Do not render hard-coded demo geometry as project model data. Viewer scenes may show neutral grid, axis, empty-state context, or one or more project-owned backend preview artifacts such as OBJ, GLTF, or GLB meshes.
