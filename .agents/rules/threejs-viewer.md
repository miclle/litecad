...
- Treat saved `.scad` / OpenSCAD-style generated models as parameterized source assets until LiteCAD ships a compatible browser compile runtime. Do not render placeholder meshes for `.scad` models, and do not route OpenSCAD source through Three.js directly.
