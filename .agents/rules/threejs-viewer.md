...
- Treat saved `.scad` / OpenSCAD-style generated models and saved `.lcad.json` / LiteCAD feature DSL generated models as parameterized source assets until their browser-worker preview paths are explicitly wired into the project preview pipeline. Do not render placeholder meshes for generated source models, and do not route generated source through Three.js directly.
