...
func newTestService(t *testing.T) *Service {
	...
	if err := db.AutoMigrate(&entity.User{}, &entity.Project{}, &entity.ProjectModel{}, &entity.ProjectModelPreviewArtifact{}, &entity.ProjectGeometryVersion{}, &entity.ProjectAgentMessage{}); err != nil {
