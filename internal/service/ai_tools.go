	...
	return AIChatTool{
		...
		Parameters: map[string]any{
			...
			"properties": map[string]any{
				...
				"code": map[string]any{
					"type":        "string",
					"description": "Complete source text. For litecad-feature-dsl, use version 1 JSON with box, box_cut, cylinder, and cylinder_cut features. box_cut uses origin and size for rectangular slots, pockets, and notches. Cylinders and cylinder cuts may include an optional non-zero axis vector, and features may include repeat with integer count 1..128 plus a step vector.",
				},
			},
		},
	}
