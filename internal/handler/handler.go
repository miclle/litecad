...
func (ctrl *Ctrl) RegisterRoutes(r *fox.Engine) {
	...
	api.GET("/projects/:projectID/export-artifacts", ctrl.ListProjectExportArtifacts)
	api.POST("/projects/:projectID/export-artifacts", ctrl.CreateProjectExportArtifact)
	api.GET("/projects/:projectID/export-artifacts/:artifactID/download", ctrl.DownloadProjectExportArtifact)
	api.GET("/projects/:projectID/inspection-records", ctrl.ListProjectInspectionRecords)
	api.POST("/projects/:projectID/inspection-records", ctrl.CreateProjectInspectionRecord)
	api.DELETE("/projects/:projectID/inspection-records/:recordID", ctrl.DeleteProjectInspectionRecord)
	api.GET("/projects/:projectID/section-artifacts", ctrl.ListProjectSectionArtifacts)
	api.POST("/projects/:projectID/section-artifacts", ctrl.CreateProjectSectionArtifact)
	api.GET("/projects/:projectID/section-artifacts/:artifactID/download", ctrl.DownloadProjectSectionArtifact)
	api.DELETE("/projects/:projectID/section-artifacts/:artifactID", ctrl.DeleteProjectSectionArtifact)
	...
	api.POST("/projects/:projectID/cad-document/groups", ctrl.CreateProjectCADAssemblyGroup)
	api.PATCH("/projects/:projectID/cad-document/groups/:groupID", ctrl.UpdateProjectCADAssemblyGroup)
	...
	api.DELETE("/projects/:projectID/cad-document/occurrences/:occurrenceID", ctrl.DeleteProjectCADOccurrence)
